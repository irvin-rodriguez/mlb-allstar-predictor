...
plt.grid(True)
plt.tight_layout()
plt.savefig("outputs/ADAM_train_val_loss.png")
plt.close()
...
plt.tight_layout()
plt.savefig("outputs/ADAM_confusion_matrix_raw.png")
plt.close()
...
plt.tight_layout()
plt.savefig("outputs/ADAM_confusion_matrix_normalized.png")
plt.close()
...
plt.legend()
plt.tight_layout()
plt.savefig("outputs/ADAM_roc_curve.png")
plt.close()
...
plt.tight_layout()
plt.savefig("outputs/ADAM_precision_recall_curve.png")
plt.close()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("outputs/ADAM_epoch_loss_vs_propagations.png")
plt.close()
